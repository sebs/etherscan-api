...
export function account(getRequest) {
    return {
        ...
        tokentx(address, contractaddress, startblock, endblock, page, offset, sort, filter) {
            const params = { module: 'account', action: 'tokentx' };
            listRange(params, startblock, endblock, page, offset, sort);
            if (address) {
                params.address = address;
            }
        ...
        tokennfttx(address, contractaddress, startblock, endblock, page, offset, sort, filter) {
            const params = { module: 'account', action: 'tokennfttx' };
            listRange(params, startblock, endblock, page, offset, sort);
            if (address) {
                params.address = address;
            }
        ...
        token1155tx(address, contractaddress, startblock, endblock, page, offset, sort, filter) {
            const params = { module: 'account', action: 'token1155tx' };
            listRange(params, startblock, endblock, page, offset, sort);
            if (address) {
                params.address = address;
            }
        ...
        txsBeaconWithdrawal(address, startblock, endblock, page, offset, sort) {
            const params = { module: 'account', action: 'txsBeaconWithdrawal', address };
            listRange(params, startblock, endblock, page, offset, sort);
            return getRequest(params);
        },
        /**
        ...
        getdeposittxs(address, startblock, endblock, page, offset, sort) {
            const params = { module: 'account', action: 'getdeposittxs', address };
            listRange(params, startblock, endblock, page, offset, sort);
            return getRequest(params);
        },
        /**
        ...
        getwithdrawaltxs(address, startblock, endblock, page, offset, sort) {
            const params = { module: 'account', action: 'getwithdrawaltxs', address };
            listRange(params, startblock, endblock, page, offset, sort);
            return getRequest(params);
        },
        /**
